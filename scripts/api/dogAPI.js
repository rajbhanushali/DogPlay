...
console.log('Recd from client','title:',req.body.p1, 'desc:',req.body.p2, 'By:',req.body.p3, 
      'status:',req.body.p4, 'price:',req.body.p5)
...
console.log('getitemById API called');
  ...
  function(err, connection)
  {
    ...
    connection.execute(
      ...
      function(err, item)
      {
        ...
        //console.log(items.metaData);
        console.log('as item.rows',item.rows);
         console.log('as item.rows[0]',item.rows[0]);
        doRelease(connection);
...
var id=req.params.itemId;
console.log('getitems by uid API called');
console.log('id is:',id);
oracledb.getConnection(
  {
    user          : dbConfig.user,
  ...
  function(err, connection)
  {
    ...
    console.log('uid passed to getitemby uid API is:',req.params.uid)
    connection.execute(
...
console.log('Recd from client',req.body.p1, req.body.p2, req.body.p3,req.body.p4,req.body.p5);
    ...
    connection.execute(
      ...
      {p1:req.body.p1, p2:req.body.p2, p3:req.body.p3, p4:req.body.p4,  p5:req.body.p5, p6:req.params.itemId},
      {autoCommit:true},
